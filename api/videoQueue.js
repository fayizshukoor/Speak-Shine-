/**
 * videoQueue.js — Concurrent in-memory video processing queue.
 * Processes up to MAX_CONCURRENT videos simultaneously (default 15).
 * Each video uses ~16 MB RAM with browser-frame optimisations, so
 * 15 slots × 16 MB = 240 MB — well within the 512 MB budget.
 */
...
// ── Concurrency limit ────────────────────────────────────────────────────────
// Override via env: VIDEO_QUEUE_CONCURRENCY=10
 ...
 * Called on every enqueue and on every job completion.
 */
function drainQueue() {
